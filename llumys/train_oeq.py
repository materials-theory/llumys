...
## when converting train.py -> train_oeq.py
## please add following -> 
    # if device.type != "cuda":
    #     raise IOError("Only CUDA is available for OEQ.")
    #     # TODO: We need to prepare the OEQ<->e3nn conversion
    #     # to use OEQ-trained version in CPU env.
    #     # or re-use pre-trained e3nn version in OEQ env. for acceleration.
